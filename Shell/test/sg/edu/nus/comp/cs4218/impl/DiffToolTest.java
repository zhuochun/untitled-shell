...
public class DiffToolTest {
	...
	public void testTwoSameMp3File() {
		try {
			File music1 = new File(System.getProperty("user.dir")
					+ "//test//Lenka - Trouble Is A Friend.mp3");
			File music2 = new File(System.getProperty("user.dir")
					+ "//test//Lenka - Trouble Is A Friend - Copy.mp3");
	...
	public void testTwoDiffMp3File() {
		try {
			File music1 = new File(System.getProperty("user.dir")
					+ "//test//Lenka - Trouble Is A Friend.mp3");
			File music2 = new File(System.getProperty("user.dir")
					+ "//test//Frankie Valli - Cant Take My Eyes Off You.mp3");
			assertTrue(diffTool.isDifferent(music1, music2));
		} catch (Exception e) {
			e.printStackTrace();
		}
